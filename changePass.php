...
mysqli_select_db($con,"sem6")or
 ...
 $tags='';
  ...
  if($password!=NULL)
  {
    $result=mysqli_query($con,"SELECT * FROM adm WHERE password='$password' ");
    $i=mysqli_num_rows($result);
    if($i)
    {
		$k1="update adm set password='$password2' where password='$password'";
			
		mysqli_query($con,$k1);
		echo '<script type="text/javascript">alert("Password has been changed"); location="adminHome.php";</script>';
		
    }
    else {
      echo '<script type="text/javascript">alert("Invalid Password!!!"); location="changePass.php";</script>';
		...
		<div id="nav">
			...
			<div id="nav-bottom">
				<div class="container">
					...
					<li><a href="adminProfileViewer.php"  >Viewer List</a></li>
